    ...
    <div className="field-group">
      ...
      <div className="image-upload">
          ...
          <div className="image-upload__preview-wrap">
            ...
            <div className="image-upload__preview-actions">
              <button
                ...
                onClick={handleRefit}
                title="Открыть кадрирование для текущего фото и перевыбрать, что попадёт в рамку виджета (8:15)"
              >
        ...
        <p className="field-hint">
          ...
          чтобы выбрать, что именно попадёт в рамку карточки виджета (вертикальная, 8:15, 560×1080);
        ...
        {widget.image_url ? (
          <>
            ...
            <button
              ...
              title="Открыть фото в кадрировании и сохранить новый кадр под рамку виджета (8:15), без открытия формы"
            >
